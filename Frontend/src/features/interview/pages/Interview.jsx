...
// ── Main Component ────────────────────────────────────────────────────────────
const getMatchSubtitle = (score) => {
    if (score >= 80) return 'Strong match for this role'
    if (score >= 60) return 'Good match with some gaps to address'
    return 'Needs preparation to improve fit'
}
...
const Interview = () => {
    ...
    const handleDownloadResume = async () => {
        ...
        try {
            ...
            setResumeError(error.response?.data?.message || 'Unable to generate resume PDF. Please try again.')
        } finally {
        ...
        <div className='interview-page'>
            ...
            <div className='interview-layout'>
                ...
                <nav className='interview-nav'>
                    ...
                    <div className='interview-nav__download'>
                        <button
                        ...
                        {resumeError && <p className='interview-nav__error' role='alert'>{resumeError}</p>}
                    </div>
                </nav>
                ...
                <aside className='interview-sidebar'>
                    ...
                    <div className='match-score'>
                        ...
                        <p className='match-score__sub'>{getMatchSubtitle(report.matchScore)}</p>
                    </div>
