...
const Home = () => {
    ...
    const { generateReport, getReports, reports } = useInterview()
    ...
    const handleGenerateReport = async () => {
        ...
        try {
            ...
            setError(requestError.response?.data?.message || "Unable to generate the interview plan.")
        } finally {
            setGenerating(false)
        }
    }
                ...
                <div className='interview-card__body'>
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            {resumeFile && <p className='upload-status' role='status'>Resume attached and ready to analyze.</p>}
                        </div>
